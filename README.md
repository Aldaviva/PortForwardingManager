...
## Extensibility
If you want this program to execute custom logic when the PIA forwarded port changes, such as sending you a notification, you can [write a plugin](https://github.com/Aldaviva/PortForwardingManager/wiki/Plugin-Authoring). These plugins take the form of .NET DLLs in the `plugins` subdirectory of the PortForwardingService installation directory.